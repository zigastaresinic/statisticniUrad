...
<select name ="selectStolpci" multiple required style="height:195px;width:130px;overflow:hidden;">
...
<select name="selectGroupBy" multiple style="margin-top: 2em; height:180px;width:130px;overflow:hidden;">
	<option disabled>Izberi stolpce</option>
	%for el in stolpci:
	<option value='{{el}}'>{{el}}</option>
	%end
...
<select name="selectOrderBy" multiple style="margin-top: 2em; height:180px;width:130px;overflow:hidden;">
	<option disabled>Izberi stolpce</option>
	%for el in stolpci:
	<option value='{{el}}'>{{el}}</option>
	%end
