...
<form action = "/4/dodaj_osebo/" method = "post">
	...
	<div class="row">
		<div class="col-md-3"><p class="text-right">Ime:</p> </div>
		<div class="col-md-8"><input type="text" class="form-control" style="width: 50%" name="ime" /> </div>
		<div class="col-xs-12" style="height:7px;"></div>
		
	
		<div class="col-md-3"><p class="text-right">Priimek:</p> </div>
		<div class="col-md-8"><input type="text" class="form-control" style="width: 50%" name="priimek" /> </div>	
		<div class="col-xs-12" style="height:7px;"></div>
	
		<div class="col-md-3"><p class="text-right">Spol:</p> </div>
		<div class="col-md-8">
			<select class = "form-control" style = "width: 50%" name="spol">
		...
		<div class="col-md-3"><p class="text-right">Datum rojstva (llll-mm-dd):</p> </div>
		<div class="col-md-8"><input type="text" class="form-control" style="width: 50%" name="datumR" /> </div>	
		<div class="col-xs-12" style="height:7px;"></div>
	
		<div class="col-md-3"><p class="text-right">Datum smrti (llll-mm-dd):</p> </div>
		<div class="col-md-8"><input type="text" class="form-control" style="width: 50%" name="datumS" /> </div>	
		<div class="col-xs-12" style="height:7px;"></div>
	
		<div class="col-md-3"><p class="text-right">Regija:</p> </div>
		<div class="col-md-8">
			<select class = "form-control" style = "width: 50%" name="regija">
		...
		<div class="col-md-3"><p class="text-right">Status:</p> </div>
		<div class="col-md-8">
		...
		<div class="col-md-3"><p class="text-right">Zakonski stan:</p> </div>
		<div class="col-md-8">
			<select class = "form-control" style = "width: 50%" name="stan">
		...
		<div class="col-md-3"><p class="text-right">Izobrazba:</p> </div>
		<div class="col-md-8">
			<select class = "form-control" style = "width: 50%" name="izobrazba">
